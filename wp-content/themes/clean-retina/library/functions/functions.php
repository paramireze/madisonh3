...
if ( !function_exists('cleanretina_nav_menu_alter') ) {
	function cleanretina_nav_menu_alter( $items, $args ) {
		$items .= '<li class="default-menu"><a href="'.esc_url( home_url() ).'" title="Navigation">'.__( 'Navigation','cleanretina' ).'</a></li>';
		return $items;
	}
}
...
if ( !function_exists('cleanretina_page_menu_alter') ) {
	function cleanretina_page_menu_alter( $output ) {
		$output .= '<li class="default-menu"><a href="'.esc_url( home_url() ).'" title="Navigation">'.__( 'Navigation','cleanretina' ).'</a></li>';
		return $output;
	}
}
